...
WRITE_PATH = 'web_data_embeddings_sbert_long_preprocessed/'

text_retriever_util = TextRetrieverSBERTLongPreprocessed()
...
for subdirectory in os.listdir('web_data/'):
    ...
    for file in os.listdir('web_data/' + subdirectory):
        ...
        """
        with open(WRITE_PATH + subdirectory + '/' + file[:-4] + '.pickle', 'wb') as handle:
