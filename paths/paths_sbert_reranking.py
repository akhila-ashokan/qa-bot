"""
WEB_DATA_EMBEDDINGS_PATH: This is the path of the folder where any pre-computed document vectors for the text retriever are stored.
...
"""
WEB_DATA_EMBEDDINGS_PATH = 'web_data_embeddings/web_data_embeddings_sbert/'
WEB_DATA_PATH = 'web_data/'
PREPROCESSED_DATA_PATH = 'preprocessed_docs/'